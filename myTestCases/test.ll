...
define i32 @main(i32 noundef %0, i8** noundef %1) #0 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 1 %7, i8 0, i64 100, i1 false)
  %8 = getelementptr inbounds [100 x i8], [100 x i8]* %6, i64 0, i64 0
  %9 = call i8* @gets(i8* noundef %8)
  %10 = getelementptr inbounds [100 x i8], [100 x i8]* %6, i64 0, i64 0
  %11 = call i32 (i8*, ...) @printf(i8* noundef %10)
  ret i32 0
}
